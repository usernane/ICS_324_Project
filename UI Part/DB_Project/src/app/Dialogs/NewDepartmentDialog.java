 ...
 * @author Ibrahim
 */
public class NewDepartmentDialog extends JDialog{
    private JButton okButton,cancelButton;
    private JTextField nameField, abbreviationField;
    private JLabel nameLabel, abbreviationLabel, uniqueIDLabel, collegeIDLabel;
    private JPanel okCancelContainer;
    private JComboBox<String> departmentIDCompoBox, collegeIDCombobox;
    ...
    private void init(){
        ...
        this.collegeIDLabel = new JLabel("College:");
        this.collegeIDCombobox = new JComboBox<>();
        ...
        for(int i = 0 ; i < SuperManager.getCollegesNames().size() ; i++){
            this.collegeIDCombobox.addItem(SuperManager.getCollegesNames().get(i));
        }
    }
    ...
    private void buildUI() {
        ...
        c.gridx = 0;
        c.gridy = 3;
        super.add(this.collegeIDLabel,c);
        c.gridx = 1;
        c.gridy = 3;
        super.add(this.collegeIDCombobox,c);
        c.gridx = 0;
        c.gridy = 4;
        c.gridwidth = 2;
            ...
            if(e.getSource() == okButton){
                if(getDepartmentName().length() != 0){
                    if(getAabbreviation().length() != 0){
                        int collegeIndex = collegeIDCombobox.getSelectedIndex();
